<template>
    <div class="imgbox">
      <img src="蓝星.jpg" class="background" />
    </div>
          ...
          <ul>
            ...
            <li>
              <input
                ...
                type="text"
                placeholder="Mobile"
                @keyup="checkMobile(mobile)"
              />
            </li>
            <li class="mobilejudge" :class="{ 'wrong': !validMobile, 'right': validMobile }">
          ...
          <ul>
            ...
            <li>
              ...
              <input
                ...
                type="checkbox"
                id="remember2"
                :disabled="!rememberName"
              />
              <span>remember all</span>
            </li>
            <li class="change-new" @click="toggleForm">register a new account?</li>
            <li class="btn">
              <button type="submit">SUBMIT</button>
            </li>
          </ul>
  ...
  import { ref } from 'vue';
      ...
      const usernameValidationText = ref('');
      const passwordValidationText = ref('');
      const mobileValidationText = ref('');
      ...
      function checkPassword(value) {
        ...
        passwordValidationText.value = validPassword.value
          ? 'right!'
          : 'Password should be English characters or numbers more than 8 words';
      }
  
      function checkMobile(value) {
        const regex = /^(13[0-9]|14[01456879]|15[0-35-9]|16[2567]|17[0-8]|18[0-9]|19[0-35-9])\d{8}$/;
        validMobile.value = regex.test(value);
        mobileValidationText.value = validMobile.value
          ? 'right!'
          : 'Please input your phone number in the correct format';
      }
  
      function handleRegister() {
        if (validUsername.value && validPassword.value && validMobile.value) {
