...
function addMeaning(i) {
    if (meaningList.value[i].Function == null || meaningList.value[i].mean == null) {
        ElMessage({
            type: "warning",
        ...
        meaningList.value.push({ mean: null, Function: null });
    }
}
        ...
        <form @submit.prevent="createWord">
            <ul>
                ...
                <li v-for="(meaning, index) in meaningList">
                    <input v-model="meaning.Function" type="text" placeholder="词性">
